const freedomScripts = () => {
    ...
    const mainHeaderNavBar = document.querySelector('.main-header__nav-bar');
    ...
    function refreshBodyPaddingTop() {
        ...
        document.documentElement.style.scrollPaddingTop = (mainHeaderNavBar.offsetHeight + 20) + 'px';
    }
    ...
    function onScroll(scrollPos) {
        if(scrollPos > 60 && scrollDirection == 'down') {
            ...
            menuDrawer.style.top = mainHeaderNavBar.offsetHeight + 'px';
            menuDrawer.style.height = 'calc(100% - ' + mainHeaderNavBar.offsetHeight + 'px)';
        } else {
