 ...
 */
class CSVImportImport extends \CSVImport\Entity\CSVImportImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'undoJob', 'comment', 'resource_type', 'has_err', 'stats'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CSVImportImport $proxy) {
